    ...
    <div class="row justify-content-center align-items-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" action="/transaksipeminjaman/{{$peminjamans->id}}" id="myForm"
                ...
                <div class="form-group">
                        ...
                        <input type="date" name="tanggal_pinjam" class="form-control" id="tanggal_pinjam" value="{{$peminjamans->tanggal_pinjam}}"
                            aria-describedby="tanggal_pinjam">
                    </div><br>
                <div class="form-group">
                         <label for="lama_peminjaman">Lama Peminjaman</label>
                        <input type="text" name="lama_peminjaman" class="form-control" id="lama_peminjaman" value="{{$peminjamans->lama_peminjaman}}"
                            aria-describedby="lama_peminjaman">
                    </div><br>
                <div class="form-group">
